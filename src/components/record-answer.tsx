    ...
    <div className="w-full flex flex-col items-center gap-8 mt-4">
      ...
      <div className="flex itece justify-center gap-3">
        <TooltipButton
          ...
          icon={
            isWebCam ? (
              <VideoOff className="text-red-600 min-w-5 min-h-5" />
            ) : (
        ...
        <TooltipButton
          ...
          icon={
            isRecording ? (
              <CircleStop className="text-red-600 min-w-5 min-h-5" />
            ) : (
        ...
        <TooltipButton
          ...
          icon={
            isAiGenerating ? (
              <Loader className="text-green-700 min-w-5 min-h-5 animate-spin" />
            ) : (
